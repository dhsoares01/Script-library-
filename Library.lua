...
function Library:CreateWindow(name)
    ...
    function window:CreateTab(tabName, icon)
        ...
        function tab:AddToggle(text, default, callback)
            ...
            ToggleBtn.Position = UDim2.new(1, -34, 0, 3)
            ToggleBtn.BackgroundColor3 = default and theme.Accent or theme.Tab
            ...
            local function updateToggle(state)
                toggled = state
                ToggleBtn.BackgroundColor3 = toggled and theme.Accent or theme.Tab
                if callback then
                    callback(toggled)
                end
            end
            ...
            ToggleBtn.MouseEnter:Connect(function()
                TweenService:Create(ToggleBtn, TweenInfo.new(0.15), { BackgroundColor3 = toggled and theme.Accent or Color3.fromRGB(60, 60, 60) }):Play()
            end)

            ToggleBtn.MouseLeave:Connect(function()
                TweenService:Create(ToggleBtn, TweenInfo.new(0.15), { BackgroundColor3 = toggled and theme.Accent or theme.Tab }):Play()
            end)
        end
    ...
    switchToPage(next(next(pages))) -- Ativa a primeira aba criada automaticamente
