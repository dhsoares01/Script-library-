--[[ 
  ...
  - Design e layout melhorados
  - Aba de Config mais rica e organizada
  - Controle de opacidade para o menu inteiro (incluindo header, abas, páginas)
  - Novas opções de customização (fonte, radius, tamanho do menu, etc)
--]]
